    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><i class="fas fa-palette mr-2"></i>Tambah Warna</h1>
            </div>

            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <form id="warnaForm" action="{{ route('master_warna.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="nama_warna">Nama Warna</label>
                                <input type="text" class="form-control @error('nama_warna') is-invalid @enderror" id="nama_warna" name="nama_warna" placeholder="Masukkan Nama Warna" value="{{ old('nama_warna') }}" required>
                                @error('nama_warna')
